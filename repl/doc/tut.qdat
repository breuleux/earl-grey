...
[70-loops = Loops] --->
  ...
  them, but they require commas instead of semicolons:
...
[81-patterns2 = ...Pattern matching] --->
  ...
  __Note: the same trick can be used with `each:
...
[90-documents = Documents] --->
  ...
  These objects can be converted to HTML using the `toHTML method:
