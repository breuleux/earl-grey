...
$targ$11 = (function(mac$0) {
  ...
  MatchHandler$0 = (function() {
    ...
    $targ$27 = 1;
    ($it$0["wrapOrder"] = $targ$27);
    [];
    return $it$0;
  });
  $targ$13 = (function(info$0) {
    var $targ$30;
    var $it$1;
    var self$0;
    $it$1 = this;
    self$0 = this;
    $targ$30 = info$0.env.mark(["symbol", info$0.gensym("ph")]);
    ($it$1["placeholder"] = $targ$30);
    [];
    return $it$1.placeholder;
  });
  (MatchHandler$0.prototype["expand"] = $targ$13);
  $targ$14 = (function(expr$0, info$1, opt$0) {
    var $it$2;
    var self$1;
    $it$2 = this;
    self$1 = this;
  ...
  (MatchHandler$0.prototype["wrap"] = $targ$14);
  __amp____colon__(MatchHandler$0, __amp____colon__((($targ$33 = "MatchHandler"), (accum$0 = ({})), (accum$0["::name"] = $targ$33), accum$0), (($targ$34 = true), (accum$1 = ({})), (accum$1["::egclass"] = $targ$34), accum$1)));
  $targ$16 = (function(ph$0$0, info$2, form$0, expr$1, flags$0) {
    var x$0;
    var t0$0;
    var other$0;
    var m$0$0;
    ...
    if (((x$0 = ph$0$0), ((x$0 instanceof Array) && (x$0[0] === "pattern")))) {
      ...
      [value$0, body$0];
      mbody$0 = parse_clauses$0(info$2, to_match$0, body$0, __amp__(opt$1, __amp____colon__((($targ$52 = (function(target$0) {
        return match_error$0(target$0);
      })), (accum$2 = ({})), (accum$2["fallback"] = $targ$52), accum$2), ({"wrap": null}))));
      return ["send", ["symbol", "let"], ["data", ["send", ["symbol", "="], ["data", to_match$0, value$0]], mbody$0]];
    }
  });
  t0$3 = getProjector(accum_flags$0)($targ$16);
  ...
  $targ$18 = (function(ctx$0, temp$0$0, form$1, ph$1$0) {
    var t4$0;
    var t3$1;
    var t2$1;
    var $targ$69;
    ...
    if (((t1$3 === 4) && (t0$4[0] === "data"))) {
      ...
      if (((t1$3 === 3) && ((t0$4[0] === "data") && ((test$1 = t0$4[1]), (t2$1 = getProjector(["multi"])(t0$4[2])), (t2$1[0] && ((t3$1 = t2$1[1]), (t4$0 = t3$1.length), ((t4$0 >= 1) && (t3$1[0] === "multi")))))))) {
        ...
        t0$5 = ph$2$0;
        t1$4 = t0$5.length;
        if (((t1$4 === 1) && (($targ$64 = t0$5[0]), (t2$2 = $targ$64), ((t2$2 instanceof Array) && (($targ$65 = t2$2.length), (t3$2 = $targ$65), ((t3$2 === 3) && ((t2$2[0] === "send") && (($targ$66 = t2$2[1]), (t4$1 = $targ$66), ((t4$1 instanceof Array) && (($targ$67 = t4$1.length), (t5$0 = $targ$67), ((t5$0 === 2) && ((t4$1[0] === "symbol") && ((t4$1[1] === "then") && (($targ$68 = t2$2[2]), (t6$0 = $targ$68), ((t6$0 instanceof Array) && (($targ$69 = t6$0.length), (t7$0 = $targ$69), ((t7$0 === 2) && (t6$0[0] === "data")))))))))))))))))) {
          a$1 = t6$0[1];
          return ["if", test$1, a$1, ["value", undefined]];
        } else {
          if (((t1$4 === 2) && (($targ$70 = t0$5[0]), (t2$2 = $targ$70), ((t2$2 instanceof Array) && (($targ$71 = t2$2.length), (t3$2 = $targ$71), ((t3$2 === 3) && ((t2$2[0] === "send") && (($targ$72 = t2$2[1]), (t4$1 = $targ$72), ((t4$1 instanceof Array) && (($targ$73 = t4$1.length), (t5$0 = $targ$73), ((t5$0 === 2) && ((t4$1[0] === "symbol") && ((t4$1[1] === "then") && (($targ$74 = t2$2[2]), (t6$0 = $targ$74), ((t6$0 instanceof Array) && (($targ$75 = t6$0.length), (t7$0 = $targ$75), ((t7$0 === 2) && ((t6$0[0] === "data") && ((a$2 = t6$0[1]), (t8$0 = t0$5[1]), ((t8$0 instanceof Array) && ((t9$0 = t8$0.length), ((t9$0 === 3) && ((t8$0[0] === "send") && ((t10$0 = t8$0[1]), ((t10$0 instanceof Array) && ((t11$0 = t10$0.length), ((t11$0 === 2) && ((t10$0[0] === "symbol") && ((t10$0[1] === "else") && ((t12$0 = t8$0[2]), ((t12$0 instanceof Array) && ((t13$0 = t12$0.length), ((t13$0 === 2) && (t12$0[0] === "data")))))))))))))))))))))))))))))))))) {
            b$3 = t12$0[1];
                ...
                $5: for (var $__2 = elifs$0.reverse()[$traceurRuntime.toProperty(Symbol.iterator)](),
                  ...
                  m$4 = $__3.value;
                  {
                    ...
                    if (((t0$9 instanceof Array) && ((t1$7 = t0$9.length), ((t1$7 === 3) && ((t0$9[0] === "send") && ((t2$5 = t0$9[1]), ((t2$5 instanceof Array) && ((t3$5 = t2$5.length), ((t3$5 === 2) && ((t2$5[0] === "symbol") && ((t2$5[1] === "elif") && ((t4$4 = t0$9[2]), ((t4$4 instanceof Array) && ((t5$3 = t4$4.length), ((t5$3 === 3) && (t4$4[0] === "data")))))))))))))))) {
                      cond$0 = t4$4[1];
                      body$3 = t4$4[2];
                      $targ$104 = ["if", cond$0, body$3, rval$0];
                      rval$0 = $targ$104;
                      rval$0;
                    } else {
  ...
  t0$10 = getProjector(mac$0("if"))($targ$18);
  if (t0$10[0]) {
    if_mac$0 = t0$10[1];
  } else {
    ___match_error($targ$18);
  }
  $targ$19 = (function(ph$3$0, temp$2$0, form$2, temp$3$0) {
    var x$1;
    var msg$0;
  ...
  t0$11 = getProjector(mac$0("else"))($targ$19);
  if (t0$11[0]) {
    else_mac$0 = t0$11[1];
  } else {
    ___match_error($targ$19);
  }
  $targ$20 = (function(ph$4$0, temp$4$0, form$3, temp$5$0) {
    var t3$6;
    var t2$6;
    var t1$8;
    var t0$12;
  ...
  t0$13 = getProjector(mac$0("not"))($targ$20);
  if (t0$13[0]) {
    not_mac$0 = t0$13[1];
  } else {
    ___match_error($targ$20);
  }
  $targ$21 = (function(ph$5$0, temp$6$0, form$4, temp$7$0) {
    var t1$9;
    var t0$14;
    var x$5;
    var x$6;
  ...
  t0$15 = getProjector(mac$0("and"))($targ$21);
  if (t0$15[0]) {
    and_mac$0 = t0$15[1];
  } else {
    ___match_error($targ$21);
  }
  $targ$22 = (function(ph$6$0, temp$8$0, form$5, temp$9$0) {
    var t1$10;
    var t0$16;
    var x$8;
    var x$9;
  ...
  t0$17 = getProjector(mac$0("or"))($targ$22);
  if (t0$17[0]) {
    or_mac$0 = t0$17[1];
  } else {
    ___match_error($targ$22);
  }
  $targ$23 = (function(context$0, temp$10$0, form$6, temp$11$0) {
    var t1$11;
    var t0$18;
    var other$5;
    var t0$19;
  ...
  t0$20 = getProjector(mac$0("when"))($targ$23);
  if (t0$20[0]) {
    when_mac$0 = t0$20[1];
  } else {
    ___match_error($targ$23);
  }
  $targ$24 = (function(temp$12$0, info$3, form$7, temp$13$0) {
    var t0$21;
    var t1$13;
    var t0$22;
    var checker$1;
  ...
  t0$24 = getProjector(mac$0("?"))($targ$24);
  if (t0$24[0]) {
    check_mac$0 = t0$24[1];
  } else {
    ___match_error($targ$24);
  }
  $targ$25 = (function(temp$14$0, info$4, form$8, temp$15$0) {
    var t0$25;
    var t1$14;
    var t0$26;
    var projector$2;
  ...
  t0$28 = getProjector(mac$0("!"))($targ$25);
  if (t0$28[0]) {
